...
<div class="wrapper">
    ...
    <div class="content-wrapper">
        ...
        <!-- 正文区域 -->
        <!--tab内容-->
        <form action="/orders/addProduct.do" method="post">
            ...
            <div class="tab-pane active" id="tab-label">
                <div class="row data-type">
                    ...
                    <div class="col-md-4 data text">
                        <input type="text" class="form-control" placeholder="请输入订单编号" name="productNum">
                    </div>


                    <div class="col-md-2 title">产品名称</div>
                    <div class="col-md-4 data text">
                        <input type="text" class="form-control" placeholder="请输入产品名称" name="productName">
                    </div>
